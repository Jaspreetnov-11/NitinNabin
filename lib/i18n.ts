...
const en = {
  ...
  read_more: "Read more ↓", show_less: "Show less ↑", show_pos: "Show all positions ↓", more_photos: "More photos ↓",
...
const hi: Strings = {
  ...
  read_more: "और पढ़ें ↓", show_less: "कम दिखाएँ ↑", show_pos: "सभी पद ↓", more_photos: "और तस्वीरें ↓",
