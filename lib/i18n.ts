...
const hi: Strings = {
  name: "नितिन नवीन", first: "नितिन", last: "नवीन",
  ...
  bio: [
    "नितिन नवीन ने 2006 में चुनावी राजनीति में प्रवेश किया, जब उनके पिता और उसी क्षेत्र से चार बार विधायक रहे नवीन किशोर प्रसाद सिन्हा के निधन के बाद पटना पश्चिम सीट पर उपचुनाव हुआ। उस समय उनकी आयु छब्बीस वर्ष थी।",
  ...
  social: {
    all: { label: "सभी फ़ीड", who: "नितिन नवीन", sub: "लाइव सोशल मीडिया अपडेट", btn: "प्रोफ़ाइल देखें", url: "#contact" },
    fb: { label: "Facebook", who: "नितिन नवीन", sub: "1,240,890 फॉलोअर्स", btn: "पेज फ़ॉलो करें", url: "https://www.facebook.com/NitinNabinBJP/" },
    x: { label: "X", who: "नितिन नवीन", sub: "@NitinNabin", btn: "फ़ॉलो करें", url: "https://x.com/NitinNabin" },
    ig: { label: "Instagram", who: "nitinnabinbjp", sub: "842 पोस्ट · 480K", btn: "फ़ॉलो करें", url: "https://www.instagram.com/nitinnabinbjp/" },
    yt: { label: "YouTube", who: "नितिन नवीन / भाजपा आधिकारिक", sub: "संबोधन एवं लाइव अपडेट", btn: "सब्सक्राइब", url: "https://www.youtube.com/@BJP4India" },
  },
};
